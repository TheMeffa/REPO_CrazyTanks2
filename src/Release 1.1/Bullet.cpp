...
void Bullet::setIsHeroBullet(const bool& isHero)
{
	isHeroBullet_ = isHero;
}


void Bullet::setShoted(const bool& isShoted)
{
	isShoted_ = isShoted;
}
...
void Bullet::setPosition (const int& x, const int& y, const MoveDirection& moveDirection)
{
	positionX_ = x;
	positionY_ = y;
